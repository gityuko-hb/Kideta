...
#[derive(Debug)]
pub enum MmapError {
    Map { reason: String, code: Option<i32> },
    Unmap { code: Option<i32> },
    Sync { kind: &'static str, code: Option<i32> },
    Advis { kind: &'static str, code: Option<i32> },
    Lock,
    Unlock,
    OutOfBounds { offset: u64, len: usize, file_size: u64 },
    ZeroSize,
    Ftruncate { code: Option<i32> },
    Mremap { code: Option<i32> },
}
